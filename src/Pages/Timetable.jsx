...
import k1 from '../assets/img/kashena/K1.jpg'
import k2 from '../assets/img/kashena/K2.jpg'
import k3 from '../assets/img/kashena/K3.jpg'
import k4 from '../assets/img/kashena/K4.jpg'
import k5 from '../assets/img/kashena/K5.jpg'
import k6 from '../assets/img/kashena/K6.jpg'
import k7 from '../assets/img/kashena/K7.jpg'
const groupData = [
    {
        name: "Феникс",
    ...
    },
    {
		...
		playcePhoto: [k1, k2, k3, k4, k5, k6, k7],
        info:[
            {weekDay: 'Понедельник', timeLong: '1 час 30 минут', timeStart: '19:00', timeEnd: '20:25', subInfo: 'Рабочие собрание проходят в перый понедельник месяца'},
