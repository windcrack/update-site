        ...
        <div className="newMemberNav-body">
            ...
            <ul className="newMemberNav-items">
                <li className="newMemberNav-item">
                    <Link className="newMemberNav-link white" to="/twelvestep">
                ...
                <li className="newMemberNav-item">
                    <Link className="newMemberNav-link white" to="/timetable">
                ...
                <li className="newMemberNav-item">
                    <Link className="newMemberNav-link white" to="/howcan">
                        Все, что нужно, чтобы стать членом Анонимных Наркоманов — желание бросить употреблять наркотики.
                    </Link>
                </li>
                <li className="newMemberNav-item">
                    <Link className="newMemberNav-link white" to="/an-meeting">
                ...
                <li className="newMemberNav-item">
                    <Link className="newMemberNav-link white" to="/members">
